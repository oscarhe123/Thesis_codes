...
class ConvOverlapBLSTM(nn.Module):
    def __init__(self, input_size, input_channels, hidden_channels, num_layers, device):
        ...
        self.conv_net = nn.Sequential(nn.Conv2d(2 * self.hidden_channels, 128, kernel_size=5, padding=2),nn.BatchNorm2d(128),
                                      nn.ReLU(),
                                      nn.Conv2d(128, 256, kernel_size=5, padding=2),nn.BatchNorm2d(256),
                                      nn.ReLU(),
                                      nn.Conv2d(256, 64, kernel_size=5, padding=2),nn.BatchNorm2d(64),
                                      nn.ReLU(),
                                      nn.Conv2d(64, 1, kernel_size=5, padding=2))
        self.init_conv_biases()

    
    def init_conv_biases(self):
    # Initialize biases of all Conv2d layers to zero
